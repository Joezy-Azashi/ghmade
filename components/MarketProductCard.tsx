...
const ProductCard = ({ product }) => {
  ...
  const handleClose = () => {
    if (added) {
      ...
      router.push("/products/marketpostRequest/[id]");
    }
    setShow(false);
  };
  ...
  return (
    <div className="col-xl-3 col-lg-4 col-md-6" id="product-card-div">
      ...
      <div className="card card-hover" id="product-card">
        <Link
          href="/products/marketpostRequest/[id]"
          as={`/products/marketpostRequest/${product.id}`}
        >
          <div
            style={{
              width: "100%",
        ...
        >
          ...
          >
            <div className="row" id="product-card__inner-row-name">
              <h5 className="market-product-name capitalize-text">
                {product.name}
              </h5>
            </div>
          </Link>
          ...
          {product.product_type === "PR" ? (
            <div className="row justify-content-between">
              <div
                className="row justify-content-start mt-3 market-price"
