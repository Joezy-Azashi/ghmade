  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      if (r(4)()) {
        ...
        var d = r(151).PDFFetchStream;
        i.setPDFNetworkStreamFactory(function (e) {
          return new d(e);
        });
      } else {
        var f = r(152).PDFNetworkStream;
        i.setPDFNetworkStreamFactory(function (e) {
          return new f(e);
        });
      }
    ...
    function (e, t, r) {
      ...
      (t.FONT_IDENTITY_MATRIX = [0.001, 0, 0, 0.001, 0, 0]),
        ...
        (t.createValidAbsoluteUrl = function (e, t) {
          if (!e) return null;
          try {
            var r = t ? new a.URL(e, t) : new a.URL(e);
            if (
              (function (e) {
                if (!e) return !1;
                switch (e.protocol) {
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r, p, v, m, g) {
        ...
        var y,
          ...
          k = !1,
          P = e.prototype,
          x = P[h] || P["@@iterator"] || (v && P[v]),
          C = x || A(v),
          R = v ? (w ? A("entries") : C) : void 0,
          E = ("Array" == t && P.entries) || x;
        if (
          (E &&
    ...
    function (e, t, r) {
      ...
      var n,
        ...
        O = !!(function () {
          try {
            var e = C.resolve(1),
              t = ((e.constructor = {})[r(28)("species")] = function (e) {
                e(E, E);
              });
            return (
    ...
    function (e, t, r) {
      ...
      var n,
        ...
        y = (e.exports = r(103)("WeakMap", m, g, u, !0, !0));
      c(function () {
      ...
      var n =
        ...
        H =
          ...
          c(function () {
            ...
            : T,
        X = function (e) {
          var t = (q[e] = k(I.prototype));
          return (t._k = e), t;
        },
        Y =
          B && "symbol" == n(I.iterator)
            ? function (e) {
                return "symbol" == (void 0 === e ? "undefined" : n(e));
              }
            : function (e) {
    ...
    function (e, t, r) {
      "use strict";
      var n = r(46),
        i = r(48).concat("length", "prototype");
      t.f =
        Object.getOwnPropertyNames ||
        function (e) {
          return n(e, i);
      ...
      !(function (e, t) {
        ...
        (function (e) {
          ...
          function (e, t, r) {
            ...
            function w(e, t) {
              var r = e._state;
              "writable" !== r ? (h("erroring" === r), P(e)) : k(e, t);
            }
            function k(e, t) {
          ...
          function (e, t, r) {
            ...
            var a = r(0),
              ...
              k = A.ResetQueue,
              P = r(2),
              x = P.AcquireWritableStreamDefaultWriter,
              C = P.IsWritableStream,
              R = P.IsWritableStreamLocked,
              E = P.WritableStreamAbort,
              T = P.WritableStreamDefaultWriterCloseWithErrorPropagation,
              O = P.WritableStreamDefaultWriterRelease,
              I = P.WritableStreamDefaultWriterWrite,
              F = P.WritableStreamCloseQueuedOrInFlight,
              L = (function () {
                function e() {
                  var t =
                      arguments.length > 0 && void 0 !== arguments[0]
    ...
    function (e, t, r) {
      ...
      var n,
        ...
        h = r(133),
        d = r(3),
        f = (n = d) && n.__esModule ? n : { default: n },
        p = r(135),
        v = r(136),
        m = r(141),
        g = r(143),
      ...
      var P,
        x = "undefined" != typeof requirejs && requirejs.load;
      if (
        ((w = k
          ? function () {
        ...
        var C = document.currentScript && document.currentScript.src;
            ...
            (e.prototype = {
              ...
              render: function (e) {
                ...
                var n = "print" === e.intent ? "print" : "display",
                  i = e.canvasFactory || new u.DOMCanvasFactory(),
                  a = new y.WebGLContext({ enable: e.enableWebGL });
                this.intentStates[n] ||
                    ...
                    var n = new WeakMap(),
                      i = {
                        data: (function e(r) {
                          ...
                          for (var l in ((i = Array.isArray(r) ? [] : {}),
                          n.set(r, i),
                          r)) {
                            for (
                              var c, h = r;
        ...
        F = (function () {
          ...
          function a() {
            var e =
              ...
              u = void 0 === o || o,
              l = e.verbosity,
              c = void 0 === l ? (0, s.getVerbosityLevel)() : l;
            if (a && i.has(a))
            ...
            (a.prototype = {
              ...
              _initialize: function () {
                var e,
                  n,
                  i = this;
                if ("undefined" != typeof Worker && !A && !r()) {
                  var a = t();
                  try {
                    ...
                    var o = new Worker(a),
                      u = new v.MessageHandler("main", "worker", o),
                      l = function () {
                  ...
                  (function () {
                    ...
                    return e
                      ...
                      : ((
                          w ||
                          function () {
                            return (0, u.loadScript)(t()).then(function () {
                    ...
                    .then(function (t) {
                      if (i.destroyed)
                        ...
                        i._port = r;
                        var n = "fake" + e++,
                          a = new v.MessageHandler(n + "_worker", n, r);
                        t.setup(a, r);
                        var o = new v.MessageHandler(n, n + "_worker", r);
                          ...
                          if (!this.commonObjs.hasData(n))
                            switch (a) {
                              case "Font":
                                ...
                                this.fontLoader.bind([d], function (e) {
                ...
                value: function (e) {
                  ...
                  var n = this.messageHandler
                    ...
                    .then(function (e) {
                      ...
                      var n = new O(r, e, t, t._params.pdfBug);
      ...
      (t.version = "2.0.943"),
        ...
        (t.getDocument = function (e) {
              ...
              if ("range" !== l)
                if ("worker" !== l)
                  if ("data" !== l || t[l] instanceof Uint8Array) n[l] = t[l];
                    ...
                    var h = t[l];
                    if ("string" == typeof h) n[l] = (0, s.stringToBytes)(h);
                    else if (
          ...
          (n.rangeChunkSize = n.rangeChunkSize || _),
            ...
            (n.pdfBug = !0 === n.pdfBug);
          var d = Object.values(s.NativeImageDecoding);
          if (
            ...
            var f = {
              ...
              m = p.GlobalWorkerOptions.workerPort;
            ...
            a.promise
              .then(function () {
                ...
                return (function (e, t, r, n) {
                  ...
                  var o = new v.MessageHandler(y, e, a.port);
    ...
    function (e, t, r) {
      ...
      var o = "noopener noreferrer nofollow",
        ...
        f = { NONE: 0, SELF: 1, BLANK: 2, PARENT: 3, TOP: 4 },
      ...
      (t.PageViewport = h),
        ...
        (t.addLinkAttributes = function (e) {
          ...
          if (
            ...
            var s = Object.values(f).includes(n) ? n : f.NONE;
            (e.target = p[s]), (e.rel = "string" == typeof a ? a : o);
          }
        }),
            ...
            n(e, [
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  try {
                    for (
                      ...
                      if (!d.attached && !d.missingFile)
                        if (
                          ((d.attached = !0), this.isFontLoadingAPISupported)
                        ) {
                          var f = d.createNativeFontFace();
                  ...
                  var v = this._queueLoadingCallback(t);
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var e = (0, i.bytesToString)(new Uint8Array(this.data)),
                    t =
                      "url(data:" + this.mimetype + ";base64," + btoa(e) + ");",
                    r =
                      '@font-face {font-family:"' +
                      this.loadedName +
                      '";src:' +
          ...
          for (var _ in ((e.prototype = {
            ...
            showText: function (e) {
              ...
              if (0 !== i) {
                ...
                if (t.patternFill) {
                  a.save();
                  var y = t.fillColor.getPattern(a, this);
      ...
      (f.prototype = {
        ...
        sendWithStream: function (e, t, r, n) {
          ...
          return new c.ReadableStream(
            {
              start: function (r) {
                var n = (0, c.createPromiseCapability)();
                return (
              ...
              pull: function (e) {
                var t = (0, c.createPromiseCapability)();
                return (
      ...
      (function (e) {
        ...
        !(function (r) {
          ...
          if (h) c && (e.exports = h);
            ...
            var _ = (P.prototype = w.prototype = Object.create(g));
            ...
            i(t, [
              {
                ...
                value: function (e) {
                  if (
                    ...
                    var t = n(this._currentFragment, 1)[0];
            ...
            drawFigures: function (e, i, u, l, c) {
              ...
              for (g = 0, y = l.length; g < y; g++)
                switch (l[g].type) {
                  case "lattice":
                    _ +=
                      ((b = (l[g].coords.length / l[g].verticesPerRow) | 0) -
                        1) *
    ...
    function (e, t, r) {
      ...
      var n,
        ...
        s = (n = o) && n.__esModule ? n : { default: n };
      var u,
        l = { fontStyle: "normal", fontWeight: "normal", fillColor: "#000000" },
        c = (function () {
          for (
      ...
      var y = (function () {
          function e(t) {
            ...
            d(this, e),
              ...
              (this.url =
                ((r = t.url),
                "file:" === (n = m.parse(r)).protocol || n.host
                  ? n
                  : /^[a-z]:[/\\]/i.test(r)
                  ? m.parse("file:///" + r)
          ...
          return (
            o(e, [
              ...
              },
              {
                key: "getRangeReader",
                value: function (e, t) {
                  var r = this.isFsUrl ? new P(this, e, t) : new w(this, e, t);
      ...
      var S = (function (e) {
          function t(e) {
            ...
            var r = l(
              ...
              n = function (t) {
                if (404 === t.statusCode) {
                  var n = new s.MissingPDFException(
                    'Missing PDF "' + r._url + '".'
                  );
                  return (
                ...
                var i = function (e) {
                  ...
                  a = (0, u.validateRangeRequestCapabilities)({
                    getResponseHeader: i,
                    isHttp: e.isHttp,
          ...
          function t(e, r, n) {
            ...
            var u = function (e) {
              if (404 !== e.statusCode) i._setReadableStream(e);
                ...
                var t = new s.MissingPDFException(
                  'Missing PDF "' + i._url + '".'
                );
                i._storedError = t;
              }
        ...
        p = (function () {
          function e(t, r, n) {
            ...
            c(this, e),
              ...
              (this._loaded = 0);
            var a = t.source;
            for (var o in ((this._withCredentials = a.withCredentials),
            (this._readCapability = (0, s.createPromiseCapability)()),
