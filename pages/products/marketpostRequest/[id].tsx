...
export default function ProductPage() {
  ...
  useEffect(() => {
    (async (productid) => {
      const rs = await new Products().getDetailedPendigProducts(productid);
      setPkey(rs.id);
  ...
  const approveProduct = async () => {
    let rs = await new Products().getDetailedPendingProducts({
      pk: pkey,
      string: "1",
    });
    callPrompt(
      "Pending Posts",
      "/products/marketpostRequest/marketpostRequest",
      "close",
  ...
  const rejectProduct = async () => {
    let rs = new Products().getDetailedPendingProducts({
      pk: pkey,
      string: "2",
    });
            ...
            <div className="row">
              <div className="col-md-6">
                {image_1 ? (
                  ...
                  <img
                    src="/assets/images/new-default.jpg"
                    style={{
                      width: "100%",
                      height: "350px",
                      objectFit: "cover",
              ...
              <div className="col-md-6">
                ...
                <div className="row ml-1 mb-2 supplier-info">
                  ...
                  <div className="row ml-2">
                    {owner.slug != "" ? (
                      <Link href="/shops/[shops]" as={`/shops/${owner.slug}`}>
                        <img
                    ...
                    {owner.slug != "" ? (
                      <Link href="/shops/[shops]" as={`/shops/${owner.slug}`}>
                        <p
                          className="mt-5 mb-5 ml-2 bsuiness-page"
                          style={{ cursor: "pointer" }}
                        >
                  ...
                  {owner.phone_number != "" ? (
                    <div className="col-md-12 owner-location">
                      <strong className="">Telephone:</strong>{" "}
                      <a
                        style={{ color: "inherit" }}
